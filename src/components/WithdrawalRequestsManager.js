  ...
  const handleApprove = async (request) => {
    ...
    try {
      ...
      await updateDoc(requestRef, {
        status: 'approved',
        approvedBy: auth.currentUser?.email || localStorage.getItem('adminEmail') || 'Admin',
      ...
      await addDoc(collection(db, 'transactions'), {
        ...
        note: `Withdrawal approved by admin (${auth.currentUser?.email || localStorage.getItem('adminEmail') || 'Admin'})`
      });
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      await updateDoc(requestRef, {
        ...
        rejectedBy: auth.currentUser?.email || localStorage.getItem('adminEmail') || 'Admin',
