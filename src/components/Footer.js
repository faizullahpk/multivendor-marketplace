        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 1.5 }}>
              <LocationOn sx={{ mr: 1, opacity: 0.7, mt: 0.2, flexShrink: 0 }} />
              <Box>
                <Typography variant="caption" sx={{ opacity: 0.5, display: 'block', fontWeight: 600, textTransform: 'uppercase', letterSpacing: 0.5 }}>
                  Global HQ — Paris, France
                </Typography>
                <Typography variant="body2" sx={{ opacity: 0.7 }}>
                  52 Rue Bayen, 75017 Paris, France
                </Typography>
              </Box>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 1.5 }}>
              ...
              <Box>
                ...
                <Typography variant="body2" sx={{ opacity: 0.7 }}>
                  Carrer de la Tapineria 10, 08002 Barcelona, Spain
                </Typography>
              </Box>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 1.5 }}>
              ...
              <Box>
                ...
                <Typography variant="body2" sx={{ opacity: 0.7 }}>
                  43 Rue d&apos;Armagnac, 33800 Bordeaux, France
                </Typography>
              </Box>
            </Box>
