                    ...
                    <Grid item xs={12} sm={2}>
                      <Box
                        ...
                        onError={(e) => {
                          ...
                          e.target.src = 'https://images.pexels.com/photos/5632402/pexels-photo-5632402.jpeg?auto=compress&cs=tinysrgb&w=200';
                        }}
                        sx={{
                          width: '100%',
                          height: 'auto',
              ...
              <CardContent>
                    ...
                    >
                      ...
                      >
                        <Box
                          ...
                          onError={(e) => {
                            e.target.onerror = null;
                            e.target.src = 'https://images.pexels.com/photos/5632402/pexels-photo-5632402.jpeg?auto=compress&cs=tinysrgb&w=100';
                          }}
                        ...
                        {item.quantity > 1 && (
                          <Box sx={{
                            ...
                            px: 0.5, fontSize: '0.65rem', lineHeight: 1.4, fontWeight: 'bold'
                          }}>
                            ×{item.quantity}
                          </Box>
                        )}
                      ...
                      <Box sx={{ flex: 1, minWidth: 0 }}>
                        ...
                        <Typography variant="body2" color="primary" fontWeight="bold" sx={{ mt: 0.3, fontSize: '0.8rem' }}>
                          ${(item.price * item.quantity).toFixed(2)}
                        </Typography>
                        {item.discount > 0 && (
                ...
                <Box sx={{ my: 1 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.8 }}>
                    <Typography variant="body2" color="text.secondary">Storehouse Price :</Typography>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Typography variant="h6" color="primary" fontWeight="bold">${calculateSubtotal().toFixed(2)}</Typography>
                </Box>
